...
def selectWorker(typeName, row):
    ...
    jinShi         = list(db['1980'].find({typeName: row, "科举功名": "进士"}))
    juRen          = list(db['1980'].find({typeName: row, "科举功名": "举人"}))
    wuJinShi       = list(db['1980'].find({typeName: row, "科举功名": "武进士"}))
    fanYiJinShi    = list(db['1980'].find({typeName: row, "科举功名": "翻译进士"}))
    fanYiJuRen     = list(db['1980'].find({typeName: row, "科举功名": "翻译举人"}))
    fanYiGongSheng = list(db['1980'].find({typeName: row, "科举功名": "翻译生员"}))
    qiTa           = list(db['1980'].find({typeName: row, "科举功名": {'$in': qiTa}}))
...
def generateReport(typeName):
    ...
    baseDir = prepareDir(u"3_1_官职名称(1980)")
